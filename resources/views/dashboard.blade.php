            ...
            <div class="card-body pb-1">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $subkriteria_count }}</div>
                    </div>
                    <div class="col-auto">
                        <i class="fas fa-tags fa-2x text-gray-300"></i>
                    </div>
                </div>
                <div class="pt-3" {{ is_hidden('subkriteria.index') }}>
                    <a href="{{ route('subkriteria.index') }}">Selengkapnya &raquo;</a>
                </div>
            </div>
        </div>
    </div>
