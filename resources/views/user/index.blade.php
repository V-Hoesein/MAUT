...
<div class="card card-primary card-outline">
	<div class="card-header">
		<form class="form-inline">
			...
			<div class="form-group mr-1" {{ is_hidden('user.cetak') }}>
				<a class="btn btn-secondary" href="{{ route('user.cetak') }}" target="_blank"><span class="fa fa-print"></span> Cetak</a>
			</div>
		</form>
	</div>
	<div class="card-body p-0 table-responsive">
		<table class="table table-bordered table-hover table-striped m-0">
			...
			<tr>
				...
				<td>
					<a class="btn btn-sm btn-info" href="{{ route('user.edit', $row) }}"><i class="fa fa-edit"></i> Ubah</a>
